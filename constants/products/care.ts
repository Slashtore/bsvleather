...
export const CARE: Product[] = [
  ...
  },
  {
    ...
    category: ProductCategory.CARE,
    price: 900,
    description: 'На основе воска, масла какао, и миндального масла. Питает кожу, защищает от влаги, скрывает мелкие царапины.',
  ...
  },
  {
    ...
    category: ProductCategory.CARE,
    price: 500,
    description: 'Проникает в глубокие слои кожи. Увлажняет, питает, смягчает и преображает структуру кожи.',
    imageUrl: '/image/oil.jpg',
    details: ['Объем 100мл', 'Придаёт блеск', 'Подходит для любой кожи']
  }
];